...
export const deleteTask = asyncHandler(
  async (req: Request, res: Response): Promise<void> => {
    ...
    await cacheService.deleteByPrefix(
      cacheKeys.taskListPrefix(authUser.userId)
    );
